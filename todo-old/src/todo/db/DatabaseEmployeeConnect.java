...
public class DatabaseEmployeeConnect
{
	...
	public static Connection openDB()
	{
		try
		{
			...
			String url = MainGui.applicationProperties.getProperty("DatabaseDsnMitarbeiter");
		...
		{
			Logger.getLogger(DatabaseEmployeeConnect.class.getName()).log(Level.SEVERE, null, ex);
