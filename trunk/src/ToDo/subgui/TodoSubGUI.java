...
public class TodoSubGUI extends javax.swing.JFrame implements ChangeListener {
    ...
    public TodoSubGUI(int status, int meetingID, String category, String topic, int todoID) {
        this.status = status;
    ...
    public void editTodo() {
        ...
        try {
            Statement stmt = con.createStatement();
            String sql = "UPDATE Protokollelement SET StatusID = '" + td.getStatusID()
                      +  "', Wiedervorlagedatum = '" + dat
                      +  "', WV_Sitzungsart = '" + td.getReMeetType()
                      +  "' WHERE ToDoID = " + todoID; 
            stmt.executeUpdate(sql);
            stmt.close();
    ...
    public ArrayList getAreasForTopic(String topicName) {
        ...
        try {
            Statement stmt = con.createStatement();
            String sql = "SELECT * FROM TBZ WHERE ThemaID="
    ...
    public ArrayList getTopicsForArea(String areaName) {
        ...
        try {
            Statement stmt = con.createStatement();
            String sql = "SELECT * FROM TBZ WHERE BereichID="
    ...
    public String getAreaNameByTBZ_ID(int tbz_id) {
        ...
        try {
            ...
            while(rst.next()) {
                ...
                String sql2 = "SELECT * FROM Bereich WHERE BereichID="
                            + rst.getInt("BereichID");
    ...
    public String getTopicNameByTBZ_ID(int tbz_id) {
        ...
        try {
            ...
            while(rst.next()) {
                Statement stmt2 = con.createStatement();
                String sql2 = "SELECT * FROM Thema WHERE ThemaID="
                            + rst.getInt("ThemaID");
                ResultSet rst2 = stmt2.executeQuery(sql2);
